$(function() {
  ...
  const sendArrowKey = (keyPressed) => {
    // Prevent markup from being injected into the message
    var message = cleanInput(keyPressed);
    ...
    if (message && connected) {
      ...
      socket.emit('new arrowkey', message);
    }
  }
  ...
  $chatPage.keydown(event => {
    if (username && event.which != 13) {     
      var inputKey;
